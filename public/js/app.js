...
var carousel = document.querySelector('.carousel__items');

if (carousel) {
  var newGap = function newGap() {
  ...
  var updateCarousel = function updateCarousel() {
    ...
    var buttons = document.querySelector('.button_carousel');
    var buttonExist = document.querySelector('.button_carousel input');
    ...
    carouselFooter.addEventListener("click", function (e) {
      ...
      if (button.tagName == "INPUT") {
        var valor = Number(button.dataset.id) * (Number(anchoCarousel) + Number(gap)) * -1;
        carousel.style.marginLeft = valor + 'px';
      }
    });
  };

  var carouselFooter = document.querySelector('.main__container__footer');
  var totalCarouselItem = carousel.childElementCount;
  ...
  var elems = document.querySelectorAll('.likecontainer');
  elems.forEach(function (elem) {
    ...
    btn.addEventListener('click', function (e) {
      ...
      if (elem.classList.contains('likeActivo')) {
        ...
        axios["delete"]('/nfts/' + nftId + '/likes/' + likeId.value, {
          nft: nftId,
          like: likeId
        }, {
          headers: {
...
var form_nft = document.querySelector('.container_form_nft');
...
if (form_nft) {
  ...
  var addListeners = function addListeners(reader) {
  ...
  var preview = document.querySelector('.imgNft');
  var reader = new FileReader();
  var buttonImage = document.querySelector('.drop_area button');
