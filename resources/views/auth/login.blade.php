...
<div class="main_container">
    <div class="login">
        ...
        <form method="POST" action="{{ route('login') }}" class="form form_auth">
            @csrf
        
            <input id="email"  type="email" name="email" :value="old('email')" placeholder="Your Email Address" autocomplete="off" required/>
